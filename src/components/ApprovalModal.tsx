      ...
      <div className="modal-content">
        <div className="modal-header">
          <h2 className="modal-title">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--warning)', marginRight: '10px' }}>
          ...
          <div className="section commands-section">
            ...
            <pre className="code-block">
              {commands.map((cmd, idx) => (
                <div key={idx} className="command-line"><span className="prompt">&gt;</span> {cmd}</div>
              ))}
            </pre>
          </div>
        ...
        <div className="modal-footer">
          ...
          <button 
            className={`btn btn-primary ${isArmed ? 'armed' : ''}`} 
