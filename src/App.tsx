      ...
      items: [
        {
          id: "session-2",
          type: 'session',
          title: "Configure Router 1",
          messages: []
        },
        {
          id: "session-3",
          type: 'session',
          title: "Troubleshoot VLAN 20",
          messages: []
        }
      ]
    },
  ...
  return (
    <div className="app-container">
      ...
      <nav className="activity-bar">
        ...
        <div className="activity-item" title="Settings" onClick={() => setIsSettingsOpen(true)}>
      ...
      <aside className={`sidebar ${isSidebarOpen ? '' : 'collapsed'}`}>
        <div className="sidebar-header">
          ...
          <div className="header-actions">
            <button className="icon-button" title="New Folder" onClick={() => {
            ...
            <button className="icon-button" title="New Chat" onClick={() => {
