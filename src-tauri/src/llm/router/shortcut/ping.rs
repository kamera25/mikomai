...
use super::{calculate_host_confidence, extract_first_capture, has_question_keywords, ShortcutRulesConfig};
...
pub fn detect_ping_shortcut(input: &str, config: &ShortcutRulesConfig) -> Option<(String, Value, String, f64)> {
    let ping_cfg = &config.fastroute.ping;
